...
def run_training():
    ...
    model_save_weights = './datasets1/seq=20_step=1/Datensatz_HHN_2_50_V4_obs/weights/flow'
    ...
    plt.title('Prediction training (Optical Flow) \nAccuracy: {0:.3f}'.format(accuracy_score(y_true.argmax(axis=1), y_pred.argmax(axis=1))))
    plt.ylabel('True label')
    plt.xlabel('Predicted label')
    plt.savefig(model_save_dir + '/confusion_flow_train.png')
    #%%
    ...
    plt.figure(figsize=(7,6))
    sns.heatmap(cm_df, cmap='Blues', annot=True, fmt='g')
    plt.title('Prediction test 1 (Optical Flow) \nAccuracy: {0:.3f}'.format(accuracy_score(y_true.argmax(axis=1), y_pred.argmax(axis=1))))
    plt.ylabel('True label')
    plt.xlabel('Predicted label')
    plt.savefig(model_save_dir + '/confusion_flow_test1.png')
    #%%
    ...
    plt.figure(figsize=(7,6))
    sns.heatmap(cm_df, cmap='Blues', annot=True, fmt='g')
    plt.title('Prediction test 2 (Optical Flow) \nAccuracy: {0:.3f}'.format(accuracy_score(y_true.argmax(axis=1), y_pred.argmax(axis=1))))
    plt.ylabel('True label')
    plt.xlabel('Predicted label')
    plt.savefig(model_save_dir + '/confusion_flow_test2.png')
    #%%
    ...
    plt.figure(figsize=(7,6))
    sns.heatmap(cm_df, cmap='Blues', annot=True, fmt='g')
    plt.title('Prediction test 3 (Optical Flow) \nAccuracy: {0:.3f}'.format(accuracy_score(y_true.argmax(axis=1), y_pred.argmax(axis=1))))
    plt.ylabel('True label')
    plt.xlabel('Predicted label')
    plt.savefig(model_save_dir + '/confusion_flow_test3.png')
    ...
    # plt.figure(figsize=(7,6))
    # sns.heatmap(cm_df, cmap='Blues', annot=True, fmt='g')
    # plt.title('Prediction test 4 (Optical Flow images) \nAccuracy: {0:.3f}'.format(accuracy_score(y_true.argmax(axis=1), y_pred.argmax(axis=1))))
    # plt.ylabel('True label')
    # plt.xlabel('Predicted label')
    # plt.savefig(model_save_dir + '/confusion_flow_test4.png')
